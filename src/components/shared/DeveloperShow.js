        ...
        <Box id="developers" display='inline' key={dev._id}>
            ...
            <ListItem>
              <Grid ml='-3'>
                ...
                <GridItem>
                  <Link href={dev.github} d-inline='true' isExternal><img src='https://www.svgrepo.com/show/332401/github.svg' width='20px' height='20px'></img><ExternalLinkIcon mx='2px' /></Link>
                </GridItem>
                <GridItem colEnd={6}>
